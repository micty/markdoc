    ...
    define('Navigator', function (require, module, exports) {
        ...
        */
        ...
        Navigator.prototype = {
            ...
            * 除了指定的视图信息，其它的全清除。
            */
            reserve: function reserve(view) {
                var meta = mapper.get(this);
                var hash = meta.router.toHash(view);
                var info = meta.hash$info[hash];

                meta.hash$info = _defineProperty({}, hash, info);
    ...
    */
    ...
    define('Navigator/Back', function (require, module, exports) {
        ...
        return {
            ...
            * 获取指定目标视图相当于当前视图的偏移量。
            */
            getOffset: function getOffset(meta, target) {
                if (!target) {
                    return -1;
                }
    ...
    define('Navigator/Infos', function (require, module, exports) {
        ...
        return {
            ...
            * 会把该视图信息的时间戳更新成最新的。
            */
            set: function set(meta, view, args) {
                var hash = meta.router.toHash(view);
        ...
        return {
            ...
            */
            create: function create(options) {
                ...
                var Storage = storage == 'session' ? require('SessionStorage') : storage == 'local' ? require('LocalStorage') : null;
    ...
    */
    ...
    define('Panel/Params', function (require, module, exports) {
        ...
        return {
            ...
            * 已重载 $on(name, selector, fn);          //绑定单个(委托)事件到单个元素上。
            */
            normalize: function normalize(name, sample, selector$fn) {
                ...
                type = typeof sample === 'undefined' ? 'undefined' : _typeof(sample);

                //重载 $on(name, selector$fn); 
                //重载 $on(name, fn);      
                if (type == 'object' || type == 'function') {
                    return _defineProperty({}, name, sample);
                }
                ...
                type = typeof selector$fn === 'undefined' ? 'undefined' : _typeof(selector$fn);

                //重载 $on(name, selector, fn);
                if (type == 'function') {
                    return _defineProperty({}, name, _defineProperty({}, sample, selector$fn));
                }
                ...
                if (type == 'object') {
                    ...
                    return _defineProperty({}, name, all);
                }
